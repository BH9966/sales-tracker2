...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    ...
    <div class="sidebar-brand">
      ...
      <a href="{{route('dashboard')}}" class="brand-link">
        ...
        <!--end::Brand Image-->
        <!--begin::Brand Text-->
        <span class="brand-text fw-light">Sales Reports</span>
        <!--end::Brand Text-->
      </a>
      <!--end::Brand Link-->
    </div>
...
<main class="app-main">
      ...
      <div class="container-fluid">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-6">
            ...
            @endif
              <form method="post" action="{{route('adduser_submit')}}">
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="mb-3">
    ...
    <!--end::App Content-->
    <button onclick="Swal.fire('Hello!','SweetAlert2 iko active','success')">
      Jaribu Alert
  </button>
  </main>
